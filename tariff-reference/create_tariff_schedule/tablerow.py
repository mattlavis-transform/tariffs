...
class tableRow(object):
	def __init__(self, sCommodityCode = "", sDescription = "", sProductLineSuffix = "", iIndents = 0, leaf = 0):
	...
	def apply(self, sCommodityCode, sDescription, sProductLineSuffix, iIndents, leaf):
		self.sCommodityCode           = sCommodityCode
		self.sDescription             = sDescription
		self.sProductLineSuffix       = sProductLineSuffix
		self.iIndents                 = iIndents
	...
	def formatDescription(self):
		...
		self.sDescription = ("<w:t>-</w:t><w:tab/>" * self.iIndents) + "<w:t>" + self.sDescription + "</w:t>"
	...
	def getIndentString(self):
		...
		self.sIndentString = "<w:ind w:left=\"" + str(oIndents[self.iIndents]) + "\" w:hanging=\"" + str(oIndents[self.iIndents]) + "\"/>"
