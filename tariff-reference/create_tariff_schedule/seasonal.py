...
class seasonal(object):
	def __init__(self, commodity_code = "", season1_start = "", season1_end = "", season1_expression = "", season2_start = "", season2_end = "", season2_expression = "", season3_start = "", season3_end = "", season3_expression = ""):
