...
class component(object):
	def __init__(self, measure_sid, duty_amount, monetary_unit_code, duty_expression_id, measurement_unit_code, measurement_unit_qualifier_code, sActive):
		# Get parameters from instantiator
		self.measure_sid							= measure_sid
		self.duty_amount							= functions.fltNone(duty_amount)
		self.monetary_unit_code						= functions.strNone(monetary_unit_code)
		self.duty_expression_id						= duty_expression_id
		self.measurement_unit_code					= functions.strNone(measurement_unit_code)
		self.measurement_unit_qualifier_code		= functions.strNone(measurement_unit_qualifier_code)
	...
	def getDutyString(self):
		...
		if self.duty_expression_id == "01":
			...
			self.duty_string += " + AC"
			functions.app.meursing_count += 1
