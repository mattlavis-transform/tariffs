...
def convert(root):
	...
	sRecordCode = ""
	iLocal = 0
	for oNode in root.findall('.//oub:goods.nomenclature.origin/../../oub:record', namespaces):
		functions.iCount += 1
		iLocal += 1
		...
		sOut += functions.edi(oNode, "oub:goods.nomenclature.origin/oub:goods.nomenclature.sid", 8, "0", functions.datatype.string)
		sOut += functions.edi(oNode, "oub:goods.nomenclature.origin/oub:derived.goods.nomenclature.item.id", 10, "0", functions.datatype.string, "left")
		sOut += functions.edi(oNode, "oub:goods.nomenclature.origin/oub:derived.productline.suffix", 2, "0", functions.datatype.string, "left")
		sOut += functions.edi(oNode, "oub:goods.nomenclature.origin/oub:goods.nomenclature.item.id", 10, "0", functions.datatype.string, "left")
		sOut += functions.edi(oNode, "oub:goods.nomenclature.origin/oub:productline.suffix", 2, "0", functions.datatype.string, "left")
		sOut += "'\n"
