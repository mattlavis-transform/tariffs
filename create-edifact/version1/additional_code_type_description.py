...
def convert(root):
	...
	sRecordCode = ""
	iLocal = 0
	for oNode in root.findall('.//oub:additional.code.type.description/../../oub:record', namespaces):
		functions.iCount += 1
		iLocal += 1
		...
		sOut += functions.edi(oNode, "oub:additional.code.type.description/oub:additional.code.type.id", 1, "0", functions.datatype.string)
		sOut += functions.edi(oNode, "oub:additional.code.type.description/oub:language.id", 2, "0", functions.datatype.string)
		sOut += functions.edi(oNode, "oub:additional.code.type.description/oub:description", -1, "0", functions.datatype.string)
		sOut += "'\n"
