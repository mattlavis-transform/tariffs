...
def convert(root):
	...
	sRecordCode = ""
	iLocal = 0
	for oNode in root.findall('.//oub:regulation.group.description/../../oub:record', namespaces):
		functions.iCount += 1
		iLocal += 1
		...
		sOut += functions.edi(oNode, "oub:regulation.group.description/oub:regulation.group.description.id", 3, "0", functions.datatype.string)
		sOut += functions.edi(oNode, "oub:regulation.group.description/oub:language.id", 2, " ", functions.datatype.date)
		sOut += functions.edi(oNode, "oub:regulation.group.description/oub:description", -1, " ", functions.datatype.date)
		sOut += "'\n"
