...
def convert(root):
	...
	sRecordCode = ""
	iLocal = 0
	for oNode in root.findall('.//oub:footnote.description.period/../../oub:record', functions.namespaces):
		functions.iCount += 1
		iLocal += 1
		...
		sOut += functions.edi(oNode, "oub:footnote.description.period/oub:footnote.description.period.sid", 8, "0", functions.datatype.string) + functions.sDivider
		sOut += functions.edi(oNode, "oub:footnote.description.period/oub:footnote.type.id", 1, "0", functions.datatype.string) + functions.sDivider
		sOut += functions.edi(oNode, "oub:footnote.description.period/oub:footnote.id", 5, "0", functions.datatype.string) + functions.sDivider
		sOut += functions.edi(oNode, "oub:footnote.description.period/oub:validity.start.date", 8, "0", functions.datatype.date) + functions.sDivider
		sOut += "'\n"
